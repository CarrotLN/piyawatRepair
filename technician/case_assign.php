<form action="case_close_db.php" method="post">
<?php
$ID=$_GET['ID'];
$query = "
...
echo '<h4> ::แบบฟอร์ฒส่งงานแจ้งซ่อม:: </h4>';
echo ' <table  class="table table-bordered table-striped table-hover">';
  ...
  echo "<tr>";
    ...
    echo "<td>"
      ...
      ."<br>"
      .' <textarea name="j_detail" required class="form-control" rows="4" cols="50" style="background-color:#99FFFF;"></textarea>'
      ."<br>"
