...
<form action="member_form_edit_db.php" method="post" class="form-horizontal" enctype="multipart/form-data">
  <div class="form-group">
    ...
    <div class="col-sm-2">
      <select name="m_level" class="form-control select2" required>

          <option selected="selected" value="<?php echo $row['m_level'];?>">
...
<!--      เลือกภาพใหม่ <br>--> <br>
        ...
        <input type="file" name="m_img"  class="custom-file-input" id="exampleInputFile" accept="image/*">
        <label class="custom-file-label" for="exampleInputFile">เลือกภาพใหม่</label>
        </div>
    </div>
  </div>
