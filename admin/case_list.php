<form method="post" action="cancel_db.php" class="form-horizontal">
<?php
$query = "
...
echo '<h4> รายการแจ้งซ่อมมาใหม่  </h4>';
echo ' <table id="example1" class="table table-bordered table-striped table-hover">';
  ...
  echo "<tr>";
    ...
    echo "<td><a href='index.php?p=ass&ID=$row[0]' class='btn btn-primary btn-sm'>มอบงาน</a> <a href='index.php?p=canceled&ID=$row[0]' class='btn btn-danger btn-sm'>ยกเลิก</a></td>";
