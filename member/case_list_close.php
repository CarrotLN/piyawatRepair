...
echo ' <table id="example1" class="table table-bordered table-striped">';
  ...
  echo "<tr>";
    ...
    echo "</td>";
    echo "<td><font color='green'>" .$row["s_name"] .  "</td> ";
    echo "<td>";
    echo "<a href='index.php?p=view&ID=$row[c_id]' class='btn btn-info btn-sm' target='_blank'>เปิดดู</a>";
    echo "</td> ";
  echo "</tr>";
  }
echo "</table>";
